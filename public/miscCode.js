...
/*
        var nameLength = className.length;
        var classType = className.slice(0,11);
        var classNumber = 0; // = className.slice(11,13);
        console.log(classType);
        if(classType === 'onoffswitch'){
            if(nameLength == 22){
                classNumber = className.slice(11,13);
            }else if(nameLength == 21){
                classNumber = className.slice(11,12);
            }else{
                //invalid needs to be implemented
            }
            switchChanged(className);
        }
*/